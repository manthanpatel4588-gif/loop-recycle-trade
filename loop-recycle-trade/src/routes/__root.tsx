...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Connect industries, scrap collectors, recyclers, and retailers in one circular economy marketplace. Cut waste, track carbon impact, source recycled materials." },
      { property: "og:title", content: "EcoLoop — AI-Powered Circular Economy Platform" },
      { property: "og:description", content: "The end-to-end SaaS for industrial waste, collection logistics, recycling, and the recycled-product marketplace." },
